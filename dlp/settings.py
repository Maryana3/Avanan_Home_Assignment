...
SECRET_KEY = '1^2+d&-025+0m0up)r99aw=t!s)qbkg1$dgp#g20(7w+cbdq8i'
...
SLACK_SINGIN_SECRET = os.getenv('SLACK_SINGIN_SECRET')
SLACK_VERIFICATION_TOKEN = os.getenv('SLACK_VERIFICATION_TOKEN')
SLACK_USER_OAUTH_TOKEN=os.getenv('SLACK_USER_OAUTH_TOKEN')
BLOCKED_PASSWORDS=os.getenv('BLOCKED_PASSWORDS').split(' ')